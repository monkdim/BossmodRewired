...
sealed class Ex2GarudaStates : StateMachineBuilder
{
    ...
    private void Phase1(uint id)
    {
        ...
        MistralSong<MistralSong2>(id + 0x10000u, 63.6f);
        SimpleState(id + 0x20000u, 37.6f, "Forced phase end");
    }
    ...
    private void MistralSong<Song>(uint id, float delay) where Song : MistralSong
    {
        ...
        Targetable(id + 1u, true, 6.8f, "Reappear")
            .ActivateOnEnter<Song>();
        Cast(id + 0x10u, AID.MistralSong, 0.6f, 1f, "Hide behind pillars")
    ...
    private void Phase2(uint id)
    {
        ...
        Subphase2(id, 87.9f);
        Subphase3(id + 0x10000u, 58.7f);
        Subphase4(id + 0x20000u, 81.1f);
        Subphase3(id + 0x30000u, 57.2f);
        Subphase4(id + 0x40000u, 80.5f);
        Subphase3(id + 0x50000u, 58.6f);
        Subphase4(id + 0x60000u, 80.5f); // ?? timings?
        SimpleState(id + 0xFF0000u, 1000f, "???");
    }

    private void Subphase2(uint id, float delay)
    {
        Targetable(id, false, delay, "Disappear", 60f)
            .ActivateOnEnter<DownburstBoss>()
        ...
        Targetable(id + 1u, true, 6.8f, "Reappear");
        Cast(id + 0x10u, AID.AerialBlast, 0.6f, 4f, "Raidwide");
    }
    ...
    private void Subphase3(uint id, float delay)
    {
        Targetable(id, false, delay, "Disappear")
            ...
            .DeactivateOnExit<DownburstBoss>()
            .DeactivateOnExit<Slipstream>();
        Targetable(id + 1u, true, 7.5f, "Reappear");
        Cast(id + 0x10u, AID.MistralShriek, 0.6f, 3f, "Raidwide");
        Targetable(id + 0x20u, false, 2.3f, "Disappear")
            .DeactivateOnExit<EyeOfTheStorm>();
        Targetable(id + 0x21u, true, 6.8f, "Reappear");
    }
