...
sealed class RadiantPlume(BossModule module) : Components.SimpleAOEs(module, (uint)AID.RadiantPlume, 8f);
...
sealed class MagitekRayCenter(BossModule module) : MagitekRay(module, (uint)AID.MagitekRayCenter);
sealed class MagitekRayLeft(BossModule module) : MagitekRay(module, (uint)AID.MagitekRayLeft);
sealed class MagitekRayRight(BossModule module) : MagitekRay(module, (uint)AID.MagitekRayRight);

sealed class AssaultCannon(BossModule module) : Components.SimpleAOEs(module, (uint)AID.AssaultCannon, new AOEShapeRect(45f, 1f));
...
public sealed class Ex1UltimaStates : StateMachineBuilder
{
...
[ModuleInfo(BossModuleInfo.Maturity.Verified, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 68u, NameID = 2137u)]
public sealed class Ex1Ultima(WorldState ws, Actor primary) : BossModule(ws, primary, default, new ArenaBoundsCircle(20f))
{
