...
{
    Coincounter = 0x4B0D // R4.0
}

public enum AID : uint
{
    AutoAttack = 872, // Coincounter->player, no cast, single-target

    TenTonzeSwipe = 45745, // Coincounter->self, 5.0s cast, range 6+R 120-degree cone
    HundredTonzeSwipe = 45744, // Coincounter->self, 3.0s cast, range 6+R 120-degree cone
    Glower = 45743, // Coincounter->self, 3.0s cast, range 17+R width 7 rect
    EyeOfTheBeholder = 45747, // Coincounter->self, 2.5s cast, range 8-15+R 270-degree donut segment
    HundredTonzeSwing = 45746 // Coincounter->self, 4.0s cast, range 8+R circle
}

public enum SID : uint
{
    Electrocution = 3779, // Coincounter->player, extra=0x0
...
sealed class D122CoincounterStates : StateMachineBuilder
{
    public D122CoincounterStates(BossModule module) : base(module)
    {
        TrivialPhase()
            ...
            .ActivateOnEnter<TenHundredTonzeSwipe>()
...
StatesType = typeof(D122CoincounterStates),
ConfigType = null,
...
TetherIDType = null,
IconIDType = null,
PrimaryActorOID = (uint)OID.Coincounter,
...
public sealed class D122Coincounter : BossModule
{
    ...
    private D122Coincounter(WorldState ws, Actor primary, (WPos center, ArenaBoundsCustom arena) a) : base(ws, primary, a.center, a.arena) { }

    private static (WPos center, ArenaBoundsCustom arena) BuildArena()
    {
        WPos[] vertices = [new(-139.18f, -177.68f), new(-138.68f, -177.28f), new(-138.39f, -176.65f), new(-138.6f, -176.02f), new(-138.38f, -175.49f),
