...
sealed class Interact(BossModule module) : BossComponent(module)
{
...
sealed class D080VioletControlUnitStates : StateMachineBuilder
{
...
[ModuleInfo(BossModuleInfo.Maturity.Verified, Contributors = "The Combat Reborn Team (Malediktus)", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 35u, NameID = 6924u, SortOrder = 6)]
public sealed class D080VioletControlUnit : BossModule
{
    public D080VioletControlUnit(WorldState ws, Actor primary) : this(ws, primary, BuildArena()) { }

    private D080VioletControlUnit(WorldState ws, Actor primary, (WPos center, ArenaBoundsCustom arena) a) : base(ws, primary, a.center, a.arena) { }

    private static (WPos center, ArenaBoundsCustom arena) BuildArena()
    {
        PolygonCustom[] poly = [new PolygonCustom([new(-70.27f, -240.33f), new(-68.42f, -240.06f), new(-67.89f, -239.64f), new(-62.61f, -233.03f), new(-62.26f, -232.49f),
        ...
        var arena = new ArenaBoundsCustom(poly, [new Rectangle(new(-0.181f, -202.993f), 1.39f, 0.9f)]);
