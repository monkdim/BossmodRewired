...
public enum AID : uint
{
    ...
    UnknownAbility1 = 47454, // Deathwall->self, no cast, range ?-30 donut
    Teleport = 47450, // Necrophobia->location, no cast, single-target
    TeleportHead = 47462, // SeveringHead->location, no cast, single-target
    ...
    AncientThunderIII1 = 47458, // Helper->self, 5.0s cast, range 60 45.000-degree cone
    AncientThunderIII2 = 47470, // SeveringHead->self, 4.7+0.8s cast, single-target
    AncientThunderIII3 = 47471, // Helper->self, 5.5s cast, range 60 45.000-degree cone
    ...
    DarkCurrent1 = 47477, // Helper->self, 5.5s cast, range 60 width 10 rect
    DarkCurrent2 = 47478, // Helper->self, 1.0s cast, range 10 width 60 rect
    ...
    HailOfHellflares1 = 47453, // Helper->self, no cast, ???
    HailOfHellflares2 = 48956, // Helper->self, no cast, single-target
    HailOfHellflares3 = 48957, // Helper->self, no cast, ???
    ...
    SeveredThunderIIIVisual = 47467, // Necrophobia->self, 4.7+0,8s cast, single-target
...
public enum SID : uint
{
    ...
    VulnerabilityUp = 2347, // Necrophobia/SeveringHead/Helper->player, extra=0x1/0x2/0x3
