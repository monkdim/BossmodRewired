...
public enum AID : uint
{
    ...
    Flare1 = 48417, // Helper->self, no cast, ???
    SealedImplementsVisual1 = 48384, // Index->self, 5.0+2.0s cast, single-target
    SealedImplementsVisual2 = 48903, // Index->self, 2.0s cast, single-target
    ...
    OmniElements1 = 48395, // Helper->self, no cast, ???
    ...
    ElementaryChemistry1 = 48402, // Helper->self, no cast, ???
    ElementaryChemistry = 48905, // Helper->self, 6.0s cast, range 15 width 15 rect
    PropulsiveProphecy = 48403, // Index->self, 3.0s cast, single-target
    Jump = 48404, // TranscribedIndex->self, no cast, single-target
    Shockwave = 48406, // Helper->self, 5.0s cast, ???, 9f kb
    Shockwave1 = 48405, // HolyLance->self, 5.0s cast, single-target
    Summon = 48408, // Index->self, 3.0s cast, single-target
    DuologyOfImplementsVisual1 = 48388, // Index->self, 5.0+1.0s cast, single-target
    DuologyOfImplementsVisual2 = 48390, // Index->self, 4.0+2,0s cast, single-target
    Iainuki = 48389, // Helper->self, 6.0s cast, range 30 60.000-degree cone
    SealedImplements2 = 48904, // Index->self, no cast, single-target
    WindSlash = 48391, // Helper->self, 6.0s cast, range 30 60.000-degree cone
...
public enum SID : uint
{
    ...
    VulnerabilityUp = 2347, // Helper->player, extra=0x1/0x2/0x3/0x4/0x5/0x6/0x7
