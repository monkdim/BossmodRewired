...
{
    public RelSimplifiedComplexPolygon Polygon = T03QueenEternal.GetXArena().Shape.Offset(-1f); // pretend polygon is 1y smaller than real for less suspect knockbacks
...
{
    public RelSimplifiedComplexPolygon Polygon = T03QueenEternal.GetXArena().Shape.Offset(-0.5f); // pretend polygon is 0.5y smaller than real for less suspect knockbacks
