...
sealed class Ch01CloudOfDarknessStates : StateMachineBuilder
{
    ...
    private void SinglePhase(uint id)
    {
        ...
        BladeOfDarkness(id + 0x10000u, 4.4f);
        DelugeOfDarkness1(id + 0x20000u, 4.5f, true);

        // note: flare starts casting ~1.9s before first criss-cross, aero/death ~3.2s after
        ComponentCondition<RazingVolleyParticleBeam>(id + 0x30000, 4f, static comp => comp.Casters.Count > 0);
    ...
    {
        Subphase1Variant1End(id, 0f);
        FloodOfDarkness1(id + 0x100000u, 8f);
        Subphase2(id + 0x200000u, 6.1f);

        DelugeOfDarkness1(id + 0x400000u, 8.2f);
    ...
    {
        Subphase1Variant2End(id, 0f);
        FloodOfDarkness1(id + 0x100000u, 11.2f);
        Subphase2(id + 0x200000u, 6.1f);
    ...
    {
        FlareUnholyDarknessBladeOfDarkness(id + 0x100u, delay);
        EndeathEnaero(id + 0x10000u, 1.4f);
        Break(id + 0x20000u, 13.2f);
        BladeOfDarknessEndeathEnaeroResolve(id + 0x30000u, 4f);
        RazingVolleyParticleBeamStart(id + 0x40000u, 4.2f);
        DeathAero(id + 0x50000u, 12.3f);
    }

    private void Subphase1Variant2End(uint id, float delay)
    {
        ComponentCondition<RazingVolleyParticleBeam>(id + 0x100u, delay, static comp => comp.NumCasts > 0, "Criss-cross start");
        DeathAero(id + 0x10000u, 3.2f);
        EndeathEnaero(id + 0x20000u, 6f);
        RapidSequenceParticleBeam(id + 0x30000u, 4.1f);
        RazingVolleyParticleBeamBladeOfDarknessEndeathEnaeroResolve(id + 0x40000u, 12.3f);
        Flare(id + 0x50000u, 9.3f);
    }

    private void Subphase2(uint id, float delay)
    {
        DelugeOfDarkness2(id, delay);
        DarkDominion(id + 0x10000u, 9.3f); // note: 1s after cast ends, outer ring becomes dangerous
        ThirdArtOfDarknessParticleConcentration(id + 0x20000u, 4f); // note: 3s after towers resolve, outer ring becomes normal
        GhastlyGloom(id + 0x30000u, 12.3f);
        CurseOfDarkness(id + 0x40000u, 8.3f);
        EvilSeedChaosCondensedDiffusiveForceParticleBeam(id + 0x50000u, 10f);
        ActivePivotParticleBeam(id + 0x70000u, 4.5f);
        LoomingChaos(id + 0x80000u, 6.2f);

        CurseOfDarkness(id + 0x100000u, 11.9f);
        ParticleConcentrationPhaser(id + 0x110000u, 4.2f);
        DarkDominion(id + 0x120000u, 1f); // note: 1s after cast ends, outer ring becomes dangerous
        FeintParticleBeamThirdActOfDarkness(id + 0x130000u, 3.1f); // note: 2.5s after act of darkness resolves, outer ring becomes normal
        GhastlyGloom(id + 0x140000u, 11.4f);
        PhaserChaosCondensedDiffusiveForceParticleBeam(id + 0x150000u, 3.3f);
        FloodOfDarknessAdds(id + 0x160000u, 2.9f);
        FloodOfDarkness2(id + 0x170000u, 8.6f);
    }
    ...
    private void RazingVolleyParticleBeamStart(uint id, float delay)
    {
        ...
        ComponentCondition<RazingVolleyParticleBeam>(id + 0x10u, 8f, comp => comp.NumCasts > 0, "Criss-cross start");
    }
    ...
    private void BladeOfDarknessEndeathEnaeroResolve(uint id, float delay)
    {
        ...
        ComponentCondition<EnaeroEndeath>(id + 0x100u, 2.2f, static comp => comp.NumCasts > 0, "Knockback/attract");
    }
    ...
    private void RazingVolleyParticleBeamBladeOfDarknessEndeathEnaeroResolve(uint id, float delay)
    {
        ...
        BladeOfDarknessEndeathEnaeroResolve(id + 0x1000u, 2.2f);
    }
    ...
    private void RapidSequenceParticleBeam(uint id, float delay)
    {
        ...
        ComponentCondition<RapidSequenceParticleBeam>(id + 0x13u, 2f, static comp => comp.NumCasts > 6, "Wild charges 3");
        ComponentCondition<RapidSequenceParticleBeam>(id + 0x14u, 2f, static comp => comp.NumCasts > 9, "Wild charges 4")
    ...
    private void FlareUnholyDarknessBladeOfDarkness(uint id, float delay)
    {
        ...
        CastEnd(id + 0x52u, 6.3f);
        ComponentCondition<BladeOfDarkness>(id + 0x53u, 0.7f, static comp => comp.NumCasts > 0, "In/out")
            .DeactivateOnExit<BladeOfDarkness>();
    }
    ...
    {
        ComponentCondition<ThirdArtOfDarknessCleave>(id, delay, static comp => comp.Mechanics.Count > 0)
        ...
        ComponentCondition<ThirdArtOfDarknessCleave>(id + 0x40u, 3f, static comp => comp.NumCasts > 4, "Add cleave 3")
        ...
        ComponentCondition<ParticleConcentration>(id + 0x50u, 3.6f, static comp => comp.Towers.Count == 0, "Towers")
            .ExecOnEnter<ParticleConcentration>(static comp => comp.ShowOuterTowers())
    ...
    {
        ComponentCondition<CurseOfDarkness>(id, delay, static comp => comp.NumCasts > 0, "Raidwide + bait debuffs")
    ...
    {
        ComponentCondition<FloodOfDarknessAdd>(id, delay, static comp => comp.Casters.Count > 0)
            .ActivateOnEnter<FloodOfDarknessAdd>();
        return Timeout(id + 1u, 6f, "Interrupt adds")
            .DeactivateOnExit<FloodOfDarknessAdd>();
    }

    private void EvilSeedChaosCondensedDiffusiveForceParticleBeam(uint id, float delay)
    {
        ComponentCondition<EvilSeedBait>(id, delay, static comp => comp.Baiters.Any())
            .ActivateOnEnter<EvilSeedBait>();
        ComponentCondition<EvilSeedAOE>(id + 0x10u, 8.1f, static comp => comp.Casters.Count > 0, "Seed plant")
            .ActivateOnEnter<EvilSeedAOE>()
            .ActivateOnEnter<EvilSeedVoidzone>()
            .DeactivateOnExit<EvilSeedBait>();

        GhastlyGloom(id + 0x1000u, 2.8f)
            .DeactivateOnExit<EvilSeedAOE>();

        ComponentCondition<ThornyVine>(id + 0x2000u, 14f, static comp => comp.Targets.Any())
        ...
        Condition(id + 0x3010u, 0.8f, () => Module.FindComponent<ChaosCondensedParticleBeam>()?.NumCasts > 0 || Module.FindComponent<DiffusiveForceParticleBeam>()?.NumCasts > 0, "Spread/line stacks")
    ...
    private void ActivePivotParticleBeam(uint id, float delay)
    {
        ...
        ComponentCondition<Phaser>(id + 2u, 8f, static comp => comp.NumCasts > 0, "Adds front/sides");
        ComponentCondition<Phaser>(id + 3u, 1.5f, static comp => comp.NumCasts >= 6, "Adds sides/front")
            .DeactivateOnExit<Phaser>();
        CastEnd(id + 4, 3.7f);
        ComponentCondition<ActivePivotParticleBeam>(id + 0x10u, 0.6f, static comp => comp.NumCasts > 0, "Rotation start");
        ComponentCondition<ActivePivotParticleBeam>(id + 0x20u, 6.6f, static comp => comp.NumCasts > 4, "Rotation end")
            .DeactivateOnExit<ActivePivotParticleBeam>();
        ComponentCondition<Excruciate>(id + 0x30u, 0.7f, static comp => comp.CurrentBaits.Count > 0)
            .ActivateOnEnter<Excruciate>();
        ComponentCondition<Excruciate>(id + 0x31u, 5f, static comp => comp.NumCasts > 0, "Adds tankbusters")
    ...
    private void ParticleConcentrationPhaser(uint id, float delay)
    {
        ...
        ComponentCondition<Phaser>(id + 1u, 1f, static comp => comp.Casters.Count > 0)
            .ActivateOnEnter<Phaser>();
        CastEnd(id + 2, 5f);
        ComponentCondition<Phaser>(id + 0x10u, 3f, static comp => comp.NumCasts > 0, "Adds front/sides")
            .ActivateOnEnter<ParticleConcentration>(); // TODO: towers appear 1s after cast end
        ComponentCondition<Phaser>(id + 0x11u, 1.5f, static comp => comp.NumCasts >= 6, "Adds sides/front")
            .DeactivateOnExit<Phaser>();
        ComponentCondition<ParticleConcentration>(id + 0x20u, 6.6f, static comp => comp.Towers.Count == 0, "Towers")
            .ExecOnEnter<ParticleConcentration>(static comp => comp.ShowOuterTowers())
            .DeactivateOnExit<ParticleConcentration>();
    }
    ...
    private void FeintParticleBeamThirdActOfDarkness(uint id, float delay)
    {
        ...
        ComponentCondition<ThirdArtOfDarknessCleave>(id + 1u, 4.9f, static comp => comp.Mechanics.Count > 0)
            ...
            .ActivateOnEnter<ThirdArtOfDarknessMultiProngedParticleBeam>();
        CastEnd(id + 2u, 1.1f);
        ComponentCondition<FeintParticleBeam>(id + 0x10u, 1.1f, static comp => comp.Chasers.Count > 0)
            .ActivateOnEnter<FeintParticleBeam>();
        ComponentCondition<FeintParticleBeam>(id + 0x11u, 4f, static comp => comp.NumCasts > 0, "Chasers start");
        ComponentCondition<ThirdArtOfDarknessCleave>(id + 0x20u, 3.5f, static comp => comp.NumCasts > 0, "Add cleave 1");
        ComponentCondition<ThirdArtOfDarknessCleave>(id + 0x30u, 3f, static comp => comp.NumCasts > 2, "Add cleave 2")
    ...
    private void PhaserChaosCondensedDiffusiveForceParticleBeam(uint id, float delay)
    {
        ...
        ComponentCondition<Phaser>(id + 0x11, 0.5f, static comp => comp.NumCasts > 0, "Adds front/sides")
            .ActivateOnEnter<ChaosCondensedParticleBeam>()
            .ActivateOnEnter<DiffusiveForceParticleBeam>();
        ComponentCondition<Phaser>(id + 0x12, 1.5f, static comp => comp.NumCasts >= 6, "Adds sides/front")
            .DeactivateOnExit<Phaser>();
        CastEnd(id + 0x13u, 6f);
        Condition(id + 0x20u, 0.8f, () => Module.FindComponent<ChaosCondensedParticleBeam>()?.NumCasts > 0 || Module.FindComponent<DiffusiveForceParticleBeam>()?.NumCasts > 0, "Spread/line stacks")
            .DeactivateOnExit<ChaosCondensedParticleBeam>()
            .DeactivateOnExit<DiffusiveForceParticleBeam>(); // TODO: show second wave ...
    }
    ...
    private void FloodOfDarkness2(uint id, float delay)
    {
        ...
        CastEnd(id + 1u, 7f, "Raidwide + arena transition")
            .SetHint(StateMachine.StateHint.Raidwide);
    }
}
