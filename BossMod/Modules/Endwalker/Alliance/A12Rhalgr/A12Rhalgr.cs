...
sealed class DestructiveBolt(BossModule module) : Components.BaitAwayCast(module, (uint)AID.DestructiveBoltAOE, 3f, tankbuster: true, damageType: AIHints.PredictedDamageType.Tankbuster);
sealed class StrikingMeteor(BossModule module) : Components.SimpleAOEs(module, (uint)AID.StrikingMeteor, 6f);
sealed class BronzeLightning(BossModule module) : Components.SimpleAOEs(module, (uint)AID.BronzeLightning, new AOEShapeCone(50f, 22.5f.Degrees()), 4);

[ModuleInfo(BossModuleInfo.Maturity.Verified, Contributors = "Malediktus", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 866u, NameID = 11273u, SortOrder = 3, PlanLevel = 90)]
public sealed class A12Rhalgr : BossModule
{
    public A12Rhalgr(WorldState ws, Actor primary) : this(ws, primary, BuildArena()) { }

    private A12Rhalgr(WorldState ws, Actor primary, (WPos center, ArenaBoundsCustom arena) a) : base(ws, primary, a.center, a.arena) { }

    private static (WPos center, ArenaBoundsCustom arena) BuildArena()
    {
        WPos[] vertices = [new(-29.125f, 235.5f), new(-31.371f, 237.971f), new(-34.382f, 241.552f), new(-36.774f, 244.204f), new(-39.093f, 246.871f),
