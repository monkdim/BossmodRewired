...
sealed class Gorgospit(BossModule module) : Components.GenericAOEs(module, (uint)AID.Gorgospit)
{
...
sealed class Snake2(BossModule module) : PetrifactionCommon(module)
{
    struct PlayerState
    {
