...
public enum PacketID
{
    ...
    PlayerRetainerInfo = 174,
    MarketBoardPurchase = 175,
    MarketBoardSale = 176,
    MarketBoardItemListingHistory = 177,
    RetainerSaleHistory = 178,
    RetainerState = 179,
    MarketBoardSearchResult = 180,
    FreeCompanyInfo = 182,
    ExamineFreeCompanyInfo = 184,
    FreeCompanyDialog = 185,
    StatusEffectList = 211,
    StatusEffectListEureka = 212,
    StatusEffectListBozja = 213,
    StatusEffectListForay3 = 214,
    StatusEffectListDouble = 215,
    EffectResult1 = 217,
    EffectResult4 = 218,
    EffectResult8 = 219,
    EffectResult16 = 220,
    EffectResultBasic1 = 222,
    EffectResultBasic4 = 223,
    EffectResultBasic8 = 224,
    EffectResultBasic16 = 225,
    EffectResultBasic32 = 226,
    EffectResultBasic64 = 227,
    ActorControl = 228,
    ActorControlSelf = 229,
    ActorControlTarget = 230,
    UpdateHpMpTp = 231,
    ActionEffect1 = 232,
    ActionEffect8 = 235,
    ActionEffect16 = 236,
    ActionEffect24 = 237,
    ActionEffect32 = 238,
    StatusEffectListPlayer = 241,
    StatusEffectListPlayerDouble = 242,
    UpdateRecastTimes = 244,
    UpdateDutyRecastTimes = 245,
    UpdateDutyRecastTimes5 = 246,
    UpdateAllianceNormal = 247,
    UpdateAllianceSmall = 248,
    UpdatePartyMemberPositions = 249,
    UpdateAllianceNormalMemberPositions = 250,
    UpdateAllianceSmallMemberPositions = 251,
    GCAffiliation = 254,
    SpawnPlayer = 272,
    SpawnNPC = 273,
    SpawnBoss = 274,
    DespawnCharacter = 275,
    ActorMove = 276,
    Transfer = 278,
    ActorSetPos = 279,
    ActorCast = 282,
    PlayerUpdateLook = 283,
    UpdateParty = 284,
    InitZone = 285,
    ApplyIDScramble = 286,
    UpdateHate = 287,
    ...
    DespawnObject = 290,
    UpdateClassInfo = 291,
    UpdateClassInfoEureka = 292,
    UpdateClassInfoBozja = 293,
    UpdateClassInfoForay3 = 294,
    PlayerSetup = 295,
    PlayerStats = 296,
    FirstAttack = 297,
    PlayerStateFlags = 298,
    PlayerClassInfo = 299,
    PlayerBlueMageActions = 300,
    ModelEquip = 301,
    Examine = 302,
    CharaNameReq = 305,
    RetainerSummary = 309,
    RetainerInformation = 310,
    ItemMarketBoardSummary = 311,
    ItemMarketBoardInfo = 312,
    ItemInfo = 314,
    ContainerInfo = 315,
    InventoryTransactionFinish = 316,
    InventoryTransaction = 317,
    CurrencyCrystalInfo = 318,
    InventoryActionAck = 320,
    UpdateInventorySlot = 321,
    OpenTreasure = 323,
    LootMessage = 326,
    CreateTreasure = 330,
    TreasureFadeOut = 331,
    ...
    QuestActiveList = 363,
    QuestUpdate = 364,
    QuestCompleteList = 365,
    QuestFinish = 366,
    MSQTrackerComplete = 369,
    QuestTracker = 371,
    Mount = 372,
    DirectorVars = 374,
    ContentDirectorSync = 375,
    ServerRequestCallbackResponse1 = 383,
    ServerRequestCallbackResponse2 = 384,
    ServerRequestCallbackResponse3 = 385,
    MapEffect1 = 407,
    MapEffect2 = 408,
    MapEffect3 = 409,
    MapEffect4 = 410,
    MapEffect5 = 411,
    MapEffect6 = 412,
    SystemLogMessage1 = 415,
    SystemLogMessage2 = 416,
    SystemLogMessage4 = 417,
    SystemLogMessage8 = 418,
    SystemLogMessage16 = 419,
    BattleTalk2 = 421,
    BattleTalk4 = 422,
    BattleTalk8 = 423,
    MapUpdate = 425,
    ...
    PlayerTitleList = 438,
    Discovery = 439,
    EorzeaTimeOffset = 441,
    EquipDisplayFlags = 454,
    NpcYell = 455,
    FateInfo = 460,
    CompletedAchievements = 465,
    LandSetInitialize = 474,
    LandUpdate = 475,
    YardObjectSpawn = 476,
    HousingIndoorInitialize = 477,
    LandAvailability = 478,
    LandPriceUpdate = 480,
    LandInfoSign = 481,
    LandRename = 482,
    HousingEstateGreeting = 483,
    HousingUpdateLandFlagsSlot = 484,
    HousingLandFlags = 485,
    HousingShowEstateGuestAccess = 486,
    HousingObjectInitialize = 488,
    HousingInternalObjectSpawn = 489,
    HousingWardInfo = 491,
    HousingObjectMove = 492,
    HousingObjectDye = 493,
    SharedEstateSettingsResponse = 505,
    DailyQuests = 517,
    DailyQuestRepeatFlags = 519,
    LandUpdateHouseName = 521,
    AirshipTimers = 532,
    PlaceMarker = 540,
    WaymarkPreset = 541,
    Waymark = 542,
    UnMount = 545,
    CeremonySetActorAppearance = 548,
    AirshipStatusList = 554,
    AirshipStatus = 555,
    AirshipExplorationResult = 556,
    SubmarineStatusList = 557,
    SubmarineProgressionStatus = 558,
    SubmarineExplorationResult = 559,
    SubmarineTimers = 561,
    DeepDungeonMap = 568,
    DeepDungeonItems = 570,
    DeepDungeonParty = 571,
    DeepDungeonChests = 572,
    PrepareZoning = 591,
    ActorGauge = 592,
    CharaVisualEffect = 593,
    LandSetMap = 594,
    Fall = 595,
    PlayMotionSync = 644,
    PlayActionTimelineSync = 647,
    CEDirector = 653,
    IslandWorkshopDemandResearch = 672,
    IslandWorkshopSupplyDemand = 675,
    IslandWorkshopFavors = 691,
}
